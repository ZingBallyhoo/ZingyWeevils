...
namespace BinWeevils.Common.Database
{
    ...
    {
        [Key] public uint m_id { get; set; }
        public ENestRoom m_type { get; set; } // maps to id in xml...
        public NestRoomColor m_color { get; set; }
    ...
    public class NestItemDB
    {
        [Key] public uint m_id { get; set; }
        public uint m_nestID { get; set; }
        public uint m_itemTypeID { get; set; }
        public ItemColor m_color { get; set; } = new ItemColor();
    ...
    public class NestPlacedGardenItemDB 
    {
        ...
        [ForeignKey(nameof(m_roomID))] public virtual NestRoomDB m_room { get; set; }
        [ForeignKey(nameof(m_id))] public virtual NestGardenItemDB m_item { get; set; }
    }
    ...
    public class NestSeedItemDB 
    {
        [Key] public uint m_id { get; set; }
        public uint m_nestID { get; set; }
        public uint m_seedTypeID { get; set; }
        public virtual NestPlantDB? m_placedItem { get; set; }
        
        [ForeignKey(nameof(m_nestID))] public virtual NestDB m_nest { get; set; }
        [ForeignKey(nameof(m_seedTypeID))] public virtual SeedType m_seedType { get; set; }
    }
    ...
    public class NestPlantDB
    {
        ...
        [ForeignKey(nameof(m_id))] public virtual NestSeedItemDB m_item { get; set; }
    }
}